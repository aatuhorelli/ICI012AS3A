...
Löysin mahdollisesti oikean merkkijonon täysin sattumalta. Tehtävässä kuitenkin suositeltiin oikean merkkijonon etsimistä pisteyttämällä tulokset sen mukaan, paljonko se sisältää yleisimpiä aakkosia. Seuraavaksi piti repäistä jostain tarpeeksi pitkä englanninkielinen teksti, josta voisi laskea kirjaimet vertailun tueksi. 
